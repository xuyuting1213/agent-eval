...
export const modelConfigs: ModelConfig[] = [
  // 智谱系列
  { value: 'glm-4.7-flash', name: 'GLM-4.7-Flash', provider: 'zhipu', desc: '新一代免费主力模型，适合高频实时问答', maxTokens: 16000, costPer1KInput: 0, costPer1KOutput: 0 },
  ...
  { value: 'gpt-4o-mini', name: 'GPT-4o Mini', provider: 'openai', desc: '更低成本的主力模型，实时任务更稳', maxTokens: 128000, costPer1KInput: 0.00015, costPer1KOutput: 0.0006 },
  ...
  { value: 'qwen3.5-plus', name: 'Qwen3.5-Plus', provider: 'aliyun', desc: '新一代高性价比模型，支持超长上下文', maxTokens: 2000000, costPer1KInput: 0.00011, costPer1KOutput: 0.00033 },
